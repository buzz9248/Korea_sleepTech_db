...
# insert 키워드: 데이터 '삽입'
# insert into 테이블명 value (레코드 값을 컬럼 순으로 콤마로 구분하여 나열);
insert into `integer` 
...
# Error Code: 1264. Out of range value for column 't_col' at row 1	0.00085 sec
-- insert into `integer` 
...
create table person(
    ...
    heights smallint unsigned	-- 키 (0 ~ 65535)
);
...
values ('Labtop', '전자제품', '삼성 갤럭시 북4 노트북 프로', 'example.com');
...
values (12345.67, 123456.7899, 9999999999999.99);
